...
/* Minimal placeholder (no firmware). Replace with the real array. */
static const uint8_t icm_dmp_firmware[] = {     /* bank # 0 */
...
static const size_t icm_dmp_firmware_size = sizeof(icm_dmp_firmware);
